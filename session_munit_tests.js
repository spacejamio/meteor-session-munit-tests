var SessionTesSuite = {
  ...
  tests:[
    ...
    {
      name: "context invalidation for get",
      func: function (test){
    ...
    {
      name: "context invalidation for equals",
      func: function (test){
    ...
    {
      name: "context invalidation for equals with undefined",
      func: function (test){
